...
public class Constant {
    ...
    //图片存放地址
    public static final String IMG_PATH = "D:\\robot\\data\\resources\\img" + File.separator;
    //图片访问地址
    public static final String IMG_ACCESS_PATH = "/resources/img/";
    //文件存放地址
    public static final String FILE_PATH = "D:\\robot\\data\\resources\\files" + File.separator;
    //文件访问地址
    public static final String FILE_ACCESS_PATH = "/resources/files/";
    //会员认证存放地址
    public static final String MEMBER_AUTHENTICATIONDATA_PATH = "D:\\robot\\data\\member\\authenticationData" + File.separator;
    //会员认证访问地址
    public static final String MEMBER_AUTHENTICATIONDATA_ACCESS_PATH = CLASS_LOADER_PATH + "/dist/tmp/member/authenticationData/";
    //联络人资料认证存放地址
    public static final String MEMBER_CONTACTINFODATAS_PATH = "D:\\robot\\data\\member\\contactInfoDatas" + File.separator;
    //联络人资料认证访问地址
    ...
    //投标附件存放位置
    public static final String BIDDING_ATTACHMENT_PATH = "D:\\robot\\data\\bidding" + File.separator;
}
