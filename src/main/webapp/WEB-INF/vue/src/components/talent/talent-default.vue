  ...
  <div id="talent-default">
    <div class="left_block">
      ...
      <div class="box3">
        <ul class="title">
          <li class="list_title">
            <a class="active" style="margin-left:15px;">专家库</a>
          </li>
      ...
      <div class="box3">
        <ul class="title">
          <li class="list_title">
            <a class="active" style="margin-left:15px;">高校</a>
          </li>
          <span class="more">-更多></span>
        </ul>
        <div style="height:170px;width:100%;">
      ...
      <div class="box3">
        <ul class="title">
          <li class="list_title">
            <a class="active" style="margin-left:15px;">专家智点</a>
          </li>
        </ul>
        <div style="height:270px;width:100%;">
          <keep-alive>
